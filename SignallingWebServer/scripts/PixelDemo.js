...
function getResponseFromUE4(data) {
	console.log(data);
	// var id = '#'+data;
...
addResponseEventListener('handle_responses', getResponseFromUE4);
...
function onParagonLoad() {
    ...
    // addResponseEventListener("handle_responses2", myHandleResponseFunction);
}
...
function onFullscreenChange(data)
{
	...
	if(fullscreenImg){
		fullscreenImg.src = isFullscreen ? 'images/MinimiseToFullscreen.svg' : 'images/MaximiseToFullscreen.svg'
